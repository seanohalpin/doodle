...
# also, what is a clean way to define and drop classes that need to be
# shared across specs?
...
raise_if_defined :AttributeDate, :Base, :DateRange, :DerivedDateRange, :SecondLevelDerivedDateRange

describe :DateRange, ' validation' do
  after :each do
    undefine_const :AttributeDate, :Base, :DateRange, :DerivedDateRange, :SecondLevelDerivedDateRange
  end
