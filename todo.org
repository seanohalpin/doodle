...
- [ ] Want specs for both flavours of use (e.g. class C < Doodle
  ...
  - so I probably want to generate the specs from templates
- [ ] reorganize specs around features
- [ ] make sure singleton inheritance working
- [ ] review specs for 1.9 - seems like Object is getting updated somehow
- [ ] also check discarding inherited method
== TODO Fixes
