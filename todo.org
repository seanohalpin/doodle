...
2008-04-16 22:08:39
== TODO Fix inspect
- don't include @__doodle__ in inspect string
== TODO Fix parents
- so doesn't rely on inspect
== TODO Finish pretty printer (to_doodle)
...
== TODO Fix up half-assed features
or get rid of them
- errors collection
- to_doodle
...
- only because this seems to be evolving standard
