...
- perhaps have a single doodle method
...
- could compare attributes in arg_order by default

== TODO pretty_print
- pp doesn't seem to like Doodle anymore
...
== TODO has + Attribute
- [ ] redefine has as a protocol so you can pass in other classes to
      use other than Doodle::Attribute

      has :thing, :use => MyClassAttribute
